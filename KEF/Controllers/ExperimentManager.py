# -*- coding: utf-8 -*-
"""
 Author: Nikhil Churamani (modified work from Pablo Barros)
...
from KEF.Controllers import LogManager
from KEF.Controllers import PlotManager
...
class ExperimentManager:
    ...
    def _createFolder(self, directoryName):
        """
            ...
            Args:
                folderName (String): the name of the new directory.
                If a nested directory, use the following notation: "folder1/folder1.1/folder1.1.1".
    ...
    def __init__(self, baseDirectory, experimentName, verbose=False):      
        """
            ...
            Args:
                ...
                experimentName (String): the name of the experimentName, which will be updated to
                experimentName+date_of_the_creation.
        ...
        self._logManager = LogManager.LogManager(self.baseDirectory + "/" + self.experimentName + "/Log/" + "Log.txt",
                                                 verbose)
